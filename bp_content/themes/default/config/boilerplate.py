config = {
    ...
    'contact_sender': "mail@terradigital.com.br",
    ...
    'aes_key': "9c20276a4330bbe719b23ac8bf3bb8a1",
    'salt': "RdbkETwF$<^>%%X^8|e[9td62`dobFL[V&F&**@`UP6vqjGL,>v+k@ma^zd6WdG0;H>o-SGG9ynk",
    ...
    # webapp2 sessions
    'webapp2_extras.sessions': { 'secret_key': 'Pe+@.1k;.@+poR1qXQm{6=j 3(9E}W!{Ll)3Y3f-#^BmlFI)a|/vY;MrSJ~f%Z4^' },

    # webapp2 authentication
    'webapp2_extras.auth': { 'cookie_name': 'td_session' },
